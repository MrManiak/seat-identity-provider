...
@section('title', trans('seat-identity-provider::saml.edit_application'))
@section('page_header', trans('seat-identity-provider::saml.edit_application'))

@section('full')
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Edit SAML Application</h3>
      <div class="card-tools">
        <a href="{{ route('seat-identity-provider.saml.applications.metadata', $application) }}" class="btn btn-primary btn-sm">
          <i class="fas fa-file-code"></i> Download IdP Metadata
        </a>
      </div>
    </div>
    <form action="{{ route('seat-identity-provider.saml.applications.update', $application) }}" method="POST">
      @csrf
      @method('PUT')
      <div class="card-body">
        @if($errors->any())
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('entity_id') is-invalid @enderror" id="entity_id" name="entity_id" value="{{ old('entity_id', $application->entity_id) }}" required>
            ...
            <div class="form-group">
              ...
              <input type="url" class="form-control @error('acs_url') is-invalid @enderror" id="acs_url" name="acs_url" value="{{ old('acs_url', $application->acs_url) }}" required>
            ...
            <div class="form-group">
              ...
              <input type="url" class="form-control @error('slo_url') is-invalid @enderror" id="slo_url" name="slo_url" value="{{ old('slo_url', $application->slo_url) }}">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="url" class="form-control @error('metadata_url') is-invalid @enderror" id="metadata_url" name="metadata_url" value="{{ old('metadata_url', $application->metadata_url) }}">
            ...
            <div class="form-group">
              ...
              <select class="form-control @error('name_id_format') is-invalid @enderror" id="name_id_format" name="name_id_format" required>
                <option value="urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress" {{ old('name_id_format', $application->name_id_format) == 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress' ? 'selected' : '' }}>Email Address</option>
                <option value="urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified" {{ old('name_id_format', $application->name_id_format) == 'urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified' ? 'selected' : '' }}>Unspecified</option>
                <option value="urn:oasis:names:tc:SAML:2.0:nameid-format:persistent" {{ old('name_id_format', $application->name_id_format) == 'urn:oasis:names:tc:SAML:2.0:nameid-format:persistent' ? 'selected' : '' }}>Persistent</option>
                <option value="urn:oasis:names:tc:SAML:2.0:nameid-format:transient" {{ old('name_id_format', $application->name_id_format) == 'urn:oasis:names:tc:SAML:2.0:nameid-format:transient' ? 'selected' : '' }}>Transient</option>
              </select>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('certificate') is-invalid @enderror" id="certificate" name="certificate" rows="5">{{ old('certificate', $application->certificate) }}</textarea>
            ...
            <div class="form-group">
              <div class="form-check">
                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $application->is_active) ? 'checked' : '' }}>
      ...
      <div class="card-footer">
        ...
        <button type="submit" class="btn btn-success float-right">Update Application</button>
      </div>
    </form>
  </div>
@stop
